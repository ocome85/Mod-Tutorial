...
public class TutorialCarRenderer extends EntityRenderer<TutorialCar> {
    private final Map<TutorialCar.Type, Pair<ResourceLocation, TutorialCarModel>> CarResources;

    public TutorialCarRenderer(EntityRendererProvider.Context p_173936_) {
        super(p_173936_);
        this.shadowRadius = 0.8F;
        this.CarResources = Stream.of(TutorialCar.Type.values()).collect(ImmutableMap.toImmutableMap((p_173938_) -> {
            return p_173938_;
        }, (p_73940_) -> {
    ...
    public void render(TutorialCar p_113929_, float p_113930_, float p_113931_, PoseStack p_113932_, MultiBufferSource p_113933_, int p_113934_) {
        ...
        if (!p_113929_.isUnderWater()) {
            ...
            Carmodel.waterPatch().render(p_113932_, vertexconsumer1, p_113934_, OverlayTexture.NO_OVERLAY);
        }
    ...
    public Pair<ResourceLocation, TutorialCarModel> getModelWithLocation(TutorialCar Car) { return this.CarResources.get(Car.getBoatType()); }
}
