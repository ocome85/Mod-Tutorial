...
public class TutorialBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final TutorialBoat.Type type;

    public TutorialBoatItem(TutorialBoat.Type p_40619_, Item.Properties p_40620_) {
        super(p_40620_);
        this.type = p_40619_;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                TutorialBoat boat = new TutorialBoat(p_40622_, hitresult.getLocation().x, hitresult.getLocation().y, hitresult.getLocation().z);
