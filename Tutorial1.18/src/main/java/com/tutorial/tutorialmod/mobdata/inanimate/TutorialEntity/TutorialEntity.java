...
import com.tutorial.tutorialmod.main.ModItems;
...
public class TutorialEntity extends LivingEntity {
    ...
    public static final EntityDataAccessor<Byte> DATA_CLIENT_FLAGS = SynchedEntityData.defineId(TutorialEntity.class, EntityDataSerializers.BYTE);
    public static final EntityDataAccessor<Rotations> DATA_HEAD_POSE = SynchedEntityData.defineId(TutorialEntity.class, EntityDataSerializers.ROTATIONS);
    public static final EntityDataAccessor<Rotations> DATA_BODY_POSE = SynchedEntityData.defineId(TutorialEntity.class, EntityDataSerializers.ROTATIONS);
    public static final EntityDataAccessor<Rotations> DATA_LEFT_ARM_POSE = SynchedEntityData.defineId(TutorialEntity.class, EntityDataSerializers.ROTATIONS);
    public static final EntityDataAccessor<Rotations> DATA_RIGHT_ARM_POSE = SynchedEntityData.defineId(TutorialEntity.class, EntityDataSerializers.ROTATIONS);
    public static final EntityDataAccessor<Rotations> DATA_LEFT_LEG_POSE = SynchedEntityData.defineId(TutorialEntity.class, EntityDataSerializers.ROTATIONS);
    public static final EntityDataAccessor<Rotations> DATA_RIGHT_LEG_POSE = SynchedEntityData.defineId(TutorialEntity.class, EntityDataSerializers.ROTATIONS);
    ...
    public TutorialEntity(EntityType<? extends TutorialEntity> p_31553_, Level p_31554_) {
        super(p_31553_, p_31554_);
        this.maxUpStep = 0.0F;
    }

    protected TutorialEntity(Level p_31556_, double p_31557_, double p_31558_, double p_31559_) {
        this(ModEntityType.TUTORIAL_ENTITY.get(), p_31556_);
    ...
    public InteractionResult interactAt(Player p_28861_, Vec3 p_31595_, InteractionHand p_28862_) {
    ...
    private void brokenByPlayer(DamageSource p_31647_) {
        Block.popResource(this.level, this.blockPosition(), new ItemStack(ModItems.TUTORIAL_ENTITY_ITEM.get()));
