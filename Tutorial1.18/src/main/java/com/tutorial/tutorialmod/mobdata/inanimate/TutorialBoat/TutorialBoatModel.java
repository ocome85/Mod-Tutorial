...
public class TutorialBoatModel extends ListModel<TutorialBoat> {
    private final ModelPart leftPaddle;
    private final ModelPart rightPaddle;
    private final ModelPart waterPatch;
    private final ImmutableList<ModelPart> parts;

    public TutorialBoatModel(ModelPart p_170462_) {
    ...
    public void setupAnim(TutorialBoat p_102269_, float p_102270_, float p_102271_, float p_102272_, float p_102273_, float p_102274_) {
    ...
    private static void animatePaddle(TutorialBoat p_170465_, int p_170466_, ModelPart p_170467_, float p_170468_) {
